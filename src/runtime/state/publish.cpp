...
ErrorCode Runtime::publish_uav_control_cmd(const std::string& peer_id,
                                           const TargetSelector& target,
...
ErrorCode Runtime::publish_sunray_runtime_diagnostic(const std::string& peer_id,
                                                     const TargetSelector& target,
...
ErrorCode Runtime::publish_host_system(const std::string& peer_id,
                                       const TargetSelector& target,
