...
int main() {
    ...
    const Bytes patch_golden = {
        ...
        0x05, 0x00, 'r',  'e',  'v',  '-',  '7',  0x02, 0x00, 0x11, 0x00, 'c', 'o', 'n',  't',
        'r',  'o',  'l',  '.',  'm',  'a',  'x',  '_',  's',  'p',  'e',  'e', 'd', 0x03, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x40, 0x0f, 0x00, 'c',  'o',  'n', 't', 'r',  'o',
        'l',  '.',  'e',  'n',  'a',  'b',  'l',  'e',  'd',  0x01, 0x01, 0x01};
    ...
    const Bytes patch_preview_golden = {
        0x00, 0x09, 0x00, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x64, 0x14, 0x00, 0x73,
        0x75, 0x6e, 0x72, 0x61, 0x79, 0x2e, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x66, 0x6c,
