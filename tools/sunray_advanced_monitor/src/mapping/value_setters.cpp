...
void set_geo(std::unordered_map<std::string, std::string>& values,
    ...
    set_float(values, prefix + "latitude_deg", msg.latitude);
    set_float(values, prefix + "longitude_deg", msg.longitude);
    set_float(values, prefix + "altitude_m", msg.altitude);
}

void set_pose(std::unordered_map<std::string, std::string>& values,
              const std::string& prefix,
              const geometry_msgs::Pose& msg) {
    set_vec3(values, prefix + "position_m", msg.position);
...
void set_twist(std::unordered_map<std::string, std::string>& values,
    ...
    set_vec3(values, prefix + "linear_mps", msg.linear);
    set_vec3(values, prefix + "angular_radps", msg.angular);
}
...
void set_odometry(std::unordered_map<std::string, std::string>& values,
    ...
    set_pose(values, prefix + "pose.", msg.pose.pose);
    set_twist(values, prefix + "twist.", msg.twist.twist);
}
...
void set_transform(std::unordered_map<std::string, std::string>& values,
    ...
    set_header(values, prefix, msg.header);
    set_value(values, prefix + "child_frame_id", msg.child_frame_id);
    set_vec3(values, prefix + "translation_m", msg.transform.translation);
    set_quat(values, prefix + "rotation", msg.transform.rotation);
}
...
void set_control_cmd(std::unordered_map<std::string, std::string>& values,
    ...
    set_vec3(values, prefix + "desired_pos_m", msg.desired_pos);
    set_vec3(values, prefix + "desired_vel_mps", msg.desired_vel);
    set_vec3(values, prefix + "desired_acc_mps2", msg.desired_acc);
    set_vec3(values, prefix + "desired_jerk", msg.desired_jerk);
    set_vec2(values, prefix + "desired_body_xy_pos_m", msg.desired_body_xy_pos);
    set_vec2(values, prefix + "desired_body_xy_vel_mps", msg.desired_body_xy_vel);
    set_float(values, prefix + "fixed_height_m", msg.fixed_height);
    set_geo(values, prefix + "desired_wgs84_pos.", msg.desired_wgs84_pos);
    set_numeric(values, prefix + "yaw_mode", msg.yaw_mode);
    set_float(values, prefix + "desired_yaw_rad", msg.desired_yaw);
    set_float(values, prefix + "desired_yaw_rate_radps", msg.desired_yaw_rate);
}
...
void set_position_target(std::unordered_map<std::string, std::string>& values,
    ...
    set_vec3(values, prefix + "position_m", msg.position);
    set_vec3(values, prefix + "velocity_mps", msg.velocity);
    set_vec3(values, prefix + "acceleration_or_force", msg.acceleration_or_force);
    set_float(values, prefix + "yaw_rad", msg.yaw);
    set_float(values, prefix + "yaw_rate_radps", msg.yaw_rate);
}
...
void set_attitude_target(std::unordered_map<std::string, std::string>& values,
    ...
    set_numeric(values, prefix + "type_mask", msg.type_mask);
    set_quat(values, prefix + "orientation", msg.orientation);
    set_vec3(values, prefix + "body_rate_radps", msg.body_rate);
