#ifndef SUNRAY_ADVANCED_MONITOR_MAPPING_VALUE_MAP_HPP
#define SUNRAY_ADVANCED_MONITOR_MAPPING_VALUE_MAP_HPP
...
#endif  // SUNRAY_ADVANCED_MONITOR_MAPPING_VALUE_MAP_HPP
