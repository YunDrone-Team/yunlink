#ifndef SUNRAY_ADVANCED_MONITOR_MODEL_COMMAND_MODEL_HPP
#define SUNRAY_ADVANCED_MONITOR_MODEL_COMMAND_MODEL_HPP
...
#endif  // SUNRAY_ADVANCED_MONITOR_MODEL_COMMAND_MODEL_HPP
