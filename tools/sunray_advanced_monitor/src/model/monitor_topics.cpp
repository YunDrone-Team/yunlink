...
void append_vec3_rows(std::vector<MonitorFieldDef>& rows,
                      const std::string& prefix,
                      const std::string& label) {
    rows.push_back(field(prefix + ".x", label + " X | " + prefix + ".x"));
    rows.push_back(field(prefix + ".y", label + " Y | " + prefix + ".y"));
...
void append_quat_rows(std::vector<MonitorFieldDef>& rows,
                      const std::string& prefix,
                      const std::string& label) {
    rows.push_back(field(prefix + ".x", label + " X | " + prefix + ".x"));
    rows.push_back(field(prefix + ".y", label + " Y | " + prefix + ".y"));
...
void append_pose_rows(std::vector<MonitorFieldDef>& rows,
                      const std::string& prefix,
                      const std::string& label) {
...
void append_twist_rows(std::vector<MonitorFieldDef>& rows,
                       const std::string& prefix,
                       const std::string& label) {
...
void append_odometry_rows(std::vector<MonitorFieldDef>& rows,
                          const std::string& prefix,
                          const std::string& label) {
...
void append_geo_rows(std::vector<MonitorFieldDef>& rows,
                     const std::string& prefix,
                     const std::string& label) {
...
void append_control_cmd_rows(std::vector<MonitorFieldDef>& rows,
                             const std::string& prefix,
                             const std::string& label) {
    append_header_rows(rows, prefix);
...
void append_position_target_rows(std::vector<MonitorFieldDef>& rows,
                                 const std::string& prefix,
                                 const std::string& label) {
    append_header_rows(rows, prefix);
...
void append_attitude_target_rows(std::vector<MonitorFieldDef>& rows,
                                 const std::string& prefix,
                                 const std::string& label) {
    append_header_rows(rows, prefix);
    rows.push_back(field(prefix + "type_mask", label + "掩码 | " + prefix + "type_mask"));
...
void append_transform_rows(std::vector<MonitorFieldDef>& rows,
                           const std::string& prefix,
                           const std::string& label) {
    append_header_rows(rows, prefix);
    rows.push_back(field(prefix + "child_frame_id", label + " child_frame_id | " + prefix + "child_frame_id"));
...
MonitorTopicState make_local_odom_topic() {
...
MonitorTopicState make_odom_state_topic() {
    MonitorTopicState topic;
...
MonitorTopicState make_control_state_topic() {
    MonitorTopicState topic;
...
MonitorTopicState make_mavros_state_topic() {
    MonitorTopicState topic;
...
MonitorTopicState make_px4_state_topic() {
    MonitorTopicState topic;
    topic.key = "px4_state";
...
std::unordered_map<std::string, MonitorTopicState> make_default_monitor_topics() {
    std::unordered_map<std::string, MonitorTopicState> topics;
