#ifndef SUNRAY_ADVANCED_MONITOR_MODEL_MONITOR_STATE_HPP
#define SUNRAY_ADVANCED_MONITOR_MODEL_MONITOR_STATE_HPP
...
#endif  // SUNRAY_ADVANCED_MONITOR_MODEL_MONITOR_STATE_HPP
