...
YUNLINK_DEFINE_TRAITS(TopicListRequest, MessageFamily::kSystemService, 13);
YUNLINK_DEFINE_TRAITS(TopicListResponse, MessageFamily::kSystemService, 14);
YUNLINK_DEFINE_TRAITS(TopicSubscriptionRequest, MessageFamily::kSystemService, 15);
YUNLINK_DEFINE_TRAITS(TopicSubscriptionResponse, MessageFamily::kSystemService, 16);
