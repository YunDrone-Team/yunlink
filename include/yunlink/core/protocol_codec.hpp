/**
 * @file include/yunlink/core/protocol_codec.hpp
 * @brief 协议编解码接口定义。
 */

#ifndef YUNLINK_CORE_PROTOCOL_CODEC_HPP
#define YUNLINK_CORE_PROTOCOL_CODEC_HPP
...
class ProtocolCodec {
  public:
    ...
    static constexpr uint8_t kMagic1 = 'U';
    static constexpr uint8_t kMagic2 = 'R';
    static constexpr uint8_t kMagic3 = 'Y';
...
#endif  // YUNLINK_CORE_PROTOCOL_CODEC_HPP
