/**
 * @file include/sunraycom/core/semantic_message_codec.hpp
 * @brief 新协议语义消息编解码接口。
 */

#ifndef SUNRAYCOM_CORE_SEMANTIC_MESSAGE_CODEC_HPP
#define SUNRAYCOM_CORE_SEMANTIC_MESSAGE_CODEC_HPP

#include <chrono>

#include "sunraycom/core/protocol_codec.hpp"
#include "sunraycom/core/semantic_message_traits.hpp"
...
#endif  // SUNRAYCOM_CORE_SEMANTIC_MESSAGE_CODEC_HPP
